...
samples_SOM_cluster <- sits_som_map(samples_organized_ungr,
                                    ...
                                    distance = "dtw",
                                    rlen = 20)
saveRDS(samples_SOM_cluster,
        file = here("r_objects", "AT_ATLIBERIA", "samples_SOM_cluster.rds"))
```
...
results <- expand_grid(prior = thresholds, posterior = thresholds) %>%
  mutate(result = map2(prior, posterior, ~ sits_som_clean_samples(
    som_map = samples_SOM_cluster,
    prior_threshold = .x,
    posterior_threshold = .y,
    keep = c("clean", "analyze")
  ))) %>%
  mutate(result_name = paste0("samples_SOM_",
                              gsub("\\.", "", as.character(prior)),
                              "_", gsub("\\.", "", as.character(posterior))))

# Extracting results into individual variables
list2env(setNames(results$result, results$result_name), .GlobalEnv)
rm(results)
```
...
results <- expand_grid(prior = thresholds, posterior = thresholds) %>%
  mutate(result = map2(prior, posterior, ~ sits_som_clean_samples(
    som_map = samples_SOM_cluster_25,
    prior_threshold = .x,
    posterior_threshold = .y,
    keep = c("clean", "analyze")
  ))) %>%
  mutate(result_name = paste0("samples_SOM_25_",
                              gsub("\\.", "", as.character(prior)),
                              "_", gsub("\\.", "", as.character(posterior))))
...
summary(samples_SOM_25_02_04)
summary(samples_SOM_25_02_06)
summary(samples_SOM_25_02_08)
summary(samples_SOM_25_04_02)
summary(samples_SOM_25_04_04)
summary(samples_SOM_25_04_06)
summary(samples_SOM_25_04_08)
summary(samples_SOM_25_06_02)
summary(samples_SOM_25_06_04)
summary(samples_SOM_25_06_06)
summary(samples_SOM_25_06_08)
summary(samples_SOM_25_08_02)
summary(samples_SOM_25_08_04)
summary(samples_SOM_25_08_06)
summary(samples_SOM_25_08_08)
```

### Summary

```{r}
samples_SOM <- bind_rows(
  summary(samples_SOM_02_02) %>%
    mutate(prior_threshold = 0.2, posterior_threshold = 0.2),
  summary(samples_SOM_04_02) %>%
    mutate(prior_threshold = 0.4, posterior_threshold = 0.2),
  summary(samples_SOM_06_02) %>%
    mutate(prior_threshold = 0.6, posterior_threshold = 0.2),
  summary(samples_SOM_08_02) %>%
    mutate(prior_threshold = 0.8, posterior_threshold = 0.2),
  summary(samples_SOM_02_04) %>%
    mutate(prior_threshold = 0.2, posterior_threshold = 0.4),
  summary(samples_SOM_04_04) %>%
    mutate(prior_threshold = 0.4, posterior_threshold = 0.4),
  summary(samples_SOM_06_04) %>%
    mutate(prior_threshold = 0.6, posterior_threshold = 0.4),
  summary(samples_SOM_08_04) %>%
    mutate(prior_threshold = 0.8, posterior_threshold = 0.4),
  summary(samples_SOM_02_06) %>%
    mutate(prior_threshold = 0.2, posterior_threshold = 0.6),
  summary(samples_SOM_04_06) %>%
    mutate(prior_threshold = 0.4, posterior_threshold = 0.6),
  summary(samples_SOM_06_06) %>%
    mutate(prior_threshold = 0.6, posterior_threshold = 0.6),
  summary(samples_SOM_08_06) %>%
    mutate(prior_threshold = 0.8, posterior_threshold = 0.6),
  summary(samples_SOM_02_08) %>%
    mutate(prior_threshold = 0.2, posterior_threshold = 0.8),
  summary(samples_SOM_04_08) %>%
    mutate(prior_threshold = 0.4, posterior_threshold = 0.8),
  summary(samples_SOM_06_08) %>%
    mutate(prior_threshold = 0.6, posterior_threshold = 0.8),
  summary(samples_SOM_08_08) %>%
    mutate(prior_threshold = 0.8, posterior_threshold = 0.8)
  )
samples_SOM %>% group_by(prior_threshold, posterior_threshold) %>%
  summarise(n_labels = n())
```

```{r}
samples_SOM_25 <- bind_rows(
  summary(samples_SOM_25_02_02) %>%
    mutate(prior_threshold = 0.2, posterior_threshold = 0.2),
  summary(samples_SOM_25_04_02) %>%
    mutate(prior_threshold = 0.4, posterior_threshold = 0.2),
...
samples_SOM_25 %>% group_by(prior_threshold, posterior_threshold) %>%
  summarise(n_labels = n())
```
...
grid.arrange(
  ggplot(samples_SOM %>%
           group_by(label, prior_threshold) %>%
           summarise(mean_prop = mean(prop)),
         aes(x = prior_threshold, y = mean_prop, fill = label)) +
    geom_bar(stat = "identity", color = "black", size = 0.1) +
    labs(title = "Proportion of Labels - grid 15 x 15",
         x = "Prior Threshold", y = "Proportion", fill = "Label") +
    theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
    scale_x_continuous(breaks = c(0.2, 0.4, 0.6, 0.8)),
  ggplot(samples_SOM_25 %>%
           group_by(label, prior_threshold) %>%
           summarise(mean_prop = mean(prop)),
         aes(x = prior_threshold, y = mean_prop, fill = label)) +
    geom_bar(stat = "identity", color = "black", size = 0.1) +
    labs(title = "Proportion of Labels - grid 25 x 25",
         x = "Prior Threshold", y = "Proportion", fill = "Label") +
    theme_minimal() +
    theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
    scale_x_continuous(breaks = c(0.2, 0.4, 0.6, 0.8)),
...
So far, do this only for samples_SOM_25_02_02.
...
saveRDS(samples_SOM_25_02_02_new_cluster,
        file = here("r_objects", "AT_ATLIBERIA", "samples_SOM_25_02_02_new_cluster.rds"))
```

## Measuring confusion between labels using the new SOM map

So far, do this only for samples_SOM_25_02_02_new_cluster.

```{r}
new_som_eval_25_02_02 <- sits_som_evaluate_cluster(samples_SOM_25_02_02_new_cluster)
```
...
<!-- ```{r eval=FALSE, include=TRUE} -->
<!-- # List of all your sample objects -->
<!-- sample_names <- c("samples_SOM_02_02", "samples_SOM_02_04", "samples_SOM_02_06", -->
<!--                   "samples_SOM_02_08", "samples_SOM_04_02", "samples_SOM_04_04", -->
<!--                   "samples_SOM_04_06", "samples_SOM_04_08", "samples_SOM_06_02", -->
<!--                   "samples_SOM_06_04", "samples_SOM_06_06", "samples_SOM_06_08", -->
<!--                   "samples_SOM_08_02", "samples_SOM_08_04", "samples_SOM_08_06", -->
<!--                   "samples_SOM_08_08") -->
...
<!--     distance = "dtw" -->
<!--   ) -->
<!--   saveRDS(new_cluster, file = here("r_objects", "AT_ATLIBERIA", -->
<!--                                    glue("{sample_name}_new_cluster.rds"))) -->
<!--   } -->

<!-- # Apply the function to each sample -->
<!-- walk(sample_names, process_sample) -->
<!-- ``` -->
...
<!-- ```{r eval=FALSE, include=TRUE} -->
<!-- # List of all your sample objects -->
<!-- sample_names_25 <- c("samples_SOM_25_02_02", "samples_SOM_25_02_04", -->
<!--                   "samples_SOM_25_02_06", "samples_SOM_25_02_08", -->
<!--                   "samples_SOM_25_04_02", "samples_SOM_25_04_04", -->
<!--                   "samples_SOM_25_04_06", "samples_SOM_25_04_08", -->
<!--                   "samples_SOM_25_06_02", "samples_SOM_25_06_04", -->
<!--                   "samples_SOM_25_06_06", "samples_SOM_25_06_08", -->
<!--                   "samples_SOM_25_08_02", "samples_SOM_25_08_04", -->
<!--                   "samples_SOM_25_08_06", "samples_SOM_25_08_08") -->

<!-- # Function to process each sample -->
<!-- process_sample_25 <- function(sample_name) { -->
<!--   sample_data <- get(sample_name) -->
<!--   new_cluster <- sits_som_map( -->
<!--     data = sample_data, -->
<!--     grid_xdim = 25, -->
...
<!-- # Apply the function to each sample -->
<!-- walk(sample_names_25, process_sample) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- new_som_eval_25_02_02 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_02_02) -->
<!-- new_som_eval_25_02_04 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_02_04) -->
<!-- new_som_eval_25_02_06 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_02_06) -->
<!-- new_som_eval_25_02_08 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_02_08) -->
<!-- new_som_eval_25_04_02 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_04_02) -->
<!-- new_som_eval_25_04_04 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_04_04) -->
<!-- new_som_eval_25_04_06 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_04_06) -->
<!-- new_som_eval_25_04_08 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_04_08) -->
<!-- new_som_eval_25_06_02 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_06_02) -->
<!-- new_som_eval_25_06_04 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_06_04) -->
<!-- new_som_eval_25_06_06 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_06_06) -->
<!-- new_som_eval_25_06_08 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_06_08) -->
<!-- new_som_eval_25_08_02 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_08_02) -->
<!-- new_som_eval_25_08_04 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_08_04) -->
<!-- new_som_eval_25_08_06 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_08_06) -->
<!-- new_som_eval_25_08_08 <- sits_som_evaluate_cluster(samples_SOM_25_new_cluster_08_08) -->
<!-- ``` -->
...
<!-- # Plot the confusion between clusters -->
<!-- plot(new_som_eval_25_02_02) -->
<!-- plot(new_som_eval_25_02_04) -->
<!-- plot(new_som_eval_25_02_06) -->
<!-- plot(new_som_eval_25_02_08) -->
<!-- plot(new_som_eval_25_04_02) -->
<!-- plot(new_som_eval_25_04_04) -->
<!-- plot(new_som_eval_25_04_06) -->
<!-- plot(new_som_eval_25_04_08) -->
<!-- plot(new_som_eval_25_06_02) -->
<!-- plot(new_som_eval_25_06_04) -->
<!-- plot(new_som_eval_25_06_06) -->
<!-- plot(new_som_eval_25_06_08) -->
<!-- plot(new_som_eval_25_08_02) -->
<!-- plot(new_som_eval_25_08_04) -->
<!-- plot(new_som_eval_25_08_06) -->
<!-- plot(new_som_eval_25_08_08) -->
<!-- ``` -->
...
For n_samples_under, use % of cover in CLC maps (Jose).#
...
## Creating the SOM map - GRID SIZES?
...
```{r}
cross_val_samples_SOM_25_02_02_new_cluster <- sits_validate(samples_SOM_25_02_02.)
saveRDS(cross_val_samples_SOM_25_02_02_new_cluster,
        file = here("r_objects", "AT_ATLIBERIA", "cross_val_samples_SOM_25_02_02_new_cluster.rds"))
```

```{r}
cross_val_samples_SOM_25_02_02_new_cluster
```
...
<!-- ```{r} -->
<!-- sample_names <- c("samples_SOM_02_02_new_cluster", -->
<!--                   "samples_SOM_02_04_new_cluster", -->
<!--                   "samples_SOM_02_06_new_cluster", -->
<!--                   "samples_SOM_02_08_new_cluster", -->
<!--                   "samples_SOM_04_02_new_cluster", -->
<!--                   "samples_SOM_04_04_new_cluster", -->
<!--                   "samples_SOM_04_06_new_cluster", -->
<!--                   "samples_SOM_04_08_new_cluster", -->
<!--                   "samples_SOM_06_02_new_cluster", -->
<!--                   "samples_SOM_06_04_new_cluster", -->
<!--                   "samples_SOM_06_06_new_cluster", -->
<!--                   "samples_SOM_06_08_new_cluster", -->
<!--                   "samples_SOM_08_02_new_cluster", -->
<!--                   "samples_SOM_08_04_new_cluster", -->
<!--                   "samples_SOM_08_06_new_cluster", -->
<!--                   "samples_SOM_08_08_new_cluster") -->
<!-- ``` -->


<!-- ```{r eval=FALSE, include=FALSE} -->
<!-- # Function to validate and save each sample -->
<!-- validate_and_save <- function(sample_name) { -->
<!--   sample_data <- get(sample_name) -->
<!--   cross_val <- sits_validate(sample_data$data) -->
<!--   saveRDS(cross_val, file = here("r_objects", "AT_ATLIBERIA", -->
<!--                                  glue("cross_val_{sample_name}.rds"))) -->
<!--   } -->

<!-- # Apply the function to each sample -->
<!-- walk(sample_names, validate_and_save) -->
<!-- ``` -->

<!-- ```{r} -->
<!-- cross_val_samples_SOM_02_02_new_cluster -->
<!-- cross_val_samples_SOM_04_02_new_cluster -->
<!-- cross_val_samples_SOM_06_02_new_cluster -->
<!-- cross_val_samples_SOM_08_02_new_cluster -->
<!-- cross_val_samples_SOM_02_04_new_cluster -->
<!-- cross_val_samples_SOM_04_04_new_cluster -->
<!-- cross_val_samples_SOM_06_04_new_cluster -->
<!-- cross_val_samples_SOM_08_04_new_cluster -->
<!-- cross_val_samples_SOM_02_06_new_cluster -->
<!-- cross_val_samples_SOM_04_06_new_cluster -->
<!-- cross_val_samples_SOM_06_06_new_cluster -->
<!-- cross_val_samples_SOM_08_06_new_cluster -->
<!-- cross_val_samples_SOM_02_08_new_cluster -->
<!-- cross_val_samples_SOM_04_08_new_cluster -->
<!-- cross_val_samples_SOM_06_08_new_cluster -->
<!-- cross_val_samples_SOM_08_08_new_cluster -->
<!-- ``` -->

<!-- ### Grid 25 x 25 -->

<!-- ```{r} -->
<!-- sample_names_25 <- c("samples_SOM_25_02_02_new_cluster", -->
<!--                   "samples_SOM_25_02_04_new_cluster", -->
<!--                   "samples_SOM_25_02_06_new_cluster", -->
<!--                   "samples_SOM_25_02_08_new_cluster", -->
<!--                   "samples_SOM_25_04_02_new_cluster", -->
<!--                   "samples_SOM_25_04_04_new_cluster", -->
<!--                   "samples_SOM_25_04_06_new_cluster", -->
<!--                   "samples_SOM_25_04_08_new_cluster", -->
<!--                   "samples_SOM_25_06_02_new_cluster", -->
<!--                   "samples_SOM_25_06_04_new_cluster", -->
<!--                   "samples_SOM_25_06_06_new_cluster", -->
<!--                   "samples_SOM_25_06_08_new_cluster", -->
<!--                   "samples_SOM_25_08_02_new_cluster", -->
<!--                   "samples_SOM_25_08_04_new_cluster", -->
<!--                   "samples_SOM_25_08_06_new_cluster", -->
<!--                   "samples_SOM_25_08_08_new_cluster") -->
<!-- ``` -->

<!-- ```{r} -->
<!-- # Apply the function to each sample -->
<!-- walk(sample_names_25, validate_and_save) -->
<!-- ``` -->

<!-- ```{r} -->
<!-- cross_val_samples_SOM_25_02_02_new_cluster -->
<!-- cross_val_samples_SOM_25_04_02_new_cluster -->
<!-- cross_val_samples_SOM_25_06_02_new_cluster -->
<!-- cross_val_samples_SOM_25_08_02_new_cluster -->
<!-- cross_val_samples_SOM_25_02_04_new_cluster -->
<!-- cross_val_samples_SOM_25_04_04_new_cluster -->
<!-- cross_val_samples_SOM_25_06_04_new_cluster -->
<!-- cross_val_samples_SOM_25_08_04_new_cluster -->
<!-- cross_val_samples_SOM_25_02_06_new_cluster -->
<!-- cross_val_samples_SOM_25_04_06_new_cluster -->
<!-- cross_val_samples_SOM_25_06_06_new_cluster -->
<!-- cross_val_samples_SOM_25_08_06_new_cluster -->
<!-- cross_val_samples_SOM_25_02_08_new_cluster -->
<!-- cross_val_samples_SOM_25_04_08_new_cluster -->
<!-- cross_val_samples_SOM_25_06_08_new_cluster -->
<!-- cross_val_samples_SOM_25_08_08_new_cluster -->
<!-- ``` -->
...
saveRDS(cross_val_RSI, file = here("r_objects", "AT_ATLIBERIA", "cross_val_RSI.rds"))
```
